...
export default async function UsersPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-4 items-center bg-zinc-50 font-sans text-zinc-900 antialiased selection:bg-zinc-900 selection:text-white dark:bg-zinc-950 dark:text-zinc-100 dark:selection:bg-zinc-100 dark:selection:text-zinc-900">
